...
const withLatency = (data, { delay = 800, shouldFail = false } = {}) =>
...
// 공통 fetch 헬퍼
export const fetchMockData = (options) => withLatency({ ...mockData, timestamp: new Date().toLocaleString() }, { delay: 1200, ...options });
...
export const fetchMockTableWide = (options) => withLatency({ headers: mockTableWideHeaders, rows: mockTableWideRows }, { delay: 700, ...options });
